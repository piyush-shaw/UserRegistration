...
namespace UserRegistrationProblem
{
    public class UserRegistration
    {
        ...
        //Pattern for checking password having 8 character and atleast one uppercase
        ...
        public static void ValidatePassword(string password)
        {
            ...
            {
                Console.WriteLine("Password must have minimum 8 character and atleast one uppercase");
            }
        }
    }
}
